...
const Contact = () => {
  const contactInfo = [
    {
      ...
      details: ['+01-4314194, +01-4315930', 'Available 24/7'],
      color: 'text-red-600'
    },
    {
      icon: Phone,
      title: 'General Enquiry',
      details: ['+01-4314194, +01-4315930', 'Mon-Sun: 8:00 AM - 8:00 PM'],
  ...
  const departments = [
    { name: 'Reception & Information', phone: '+01-4314194, +01-4315930', ext: 'Ext: 100' },
    { name: 'Emergency Department', phone: '+01-4314194, +01-4315930', ext: '24/7' },
    { name: 'Appointment Booking', phone: '+01-4314194, +01-4315930', ext: 'Ext: 102' },
    { name: 'Billing & Insurance', phone: '+01-4314194, +01-4315930', ext: 'Ext: 103' },
    { name: 'Patient Relations', phone: '++01-4314194, +01-4315930', ext: 'Ext: 104' },
    { name: 'Pharmacy', phone: '+01-4314194, +01-4315930', ext: 'Ext: 105' }
  ];
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Free parking available for 20+ vehicles</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Bus className="w-5 h-5 text-emerald-600" />
                    <span>Multiple bus routes and connectivity</span>
                  </div>
                  <div className="flex items-center space-x-3">
                ...
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p className="text-gray-600 text-sm">
                      Take the main highway exit towards Satungal. 
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p className="text-gray-600 text-sm">
                      Bus routes Satungal stop directly at the APF hospital.
                    </p>
                  </div>
                  <div className="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      "Bageshwari Hospital, Satungal, Chandragiri-11, Kathmandu".
                    </p>
                  </div>
                </div>
              </div>
