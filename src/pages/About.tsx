...
const About = () => {
  const achievements = [
    {
      icon: Award,
      title: 'Chandragiri Municipality Accredited',
      description: 'Bageshwari Hospital is a 15 beded private hospital accredated by Chandragiri Municipality.'
    },
    {
      icon: Users,
      title: '20+ Expert Doctors',
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-emerald-100 max-w-2xl mx-auto">
              Bageshwari Hospital was established in 2064 BS, as the First Private Hospital in Chandragiri Municipality. We are dedicated to providing exceptional healthcare services with compassion, expertise, and state-of-the-art medical technology. We have been the first responder for trauma and accident victims from around Prithvi Highway and surrounding areas for over 18+ years. We continue to improve our care with the motto of best compassionate care at an Affordable cost.
            </p>
          </div>
        </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                />
                <h3 className="text-xl font-bold text-gray-900 mb-2">Dr. Mithila Sharma</h3>
                <p className="text-emerald-600 font-medium mb-2">Chairman</p>
                <p className="text-gray-600 text-sm">MBBS, MD - 25+ years of healthcare leadership experience</p>
              </div>
              ...
              <div className="text-center">
                <img 
                  ...
                  className="w-32 h-32 rounded-full object-cover mx-auto mb-4 border-4 border-emerald-100"
                />
                <h3 className="text-xl font-bold text-gray-900 mb-2">Prof. Dr. Deepak Dutta</h3>
                <p className="text-emerald-600 font-medium mb-2">Medical Director</p>
                <p className="text-gray-600 text-sm">MBBS, MS - Specialist in Orthopaedics Trauma and Joint Replacement</p>
              </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-2">High Dependency Unit (HDU)</h3>
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-2">Digital X-Ray alongwith Radiological Services</h3>
