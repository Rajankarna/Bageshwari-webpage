...
emailjs.init('_HhkB_i5TEDC3E1cp');

// Define EmailJS service and template IDs (replace with your actual IDs)
const SERVICE_ID = 'service_fthqy75';
const TEMPLATE_ID_ADMIN = 'template_df4xlmp';
...
const AppointmentSection: React.FC = () => {
  ...
  const doctorsByDepartment: Record<string, Doctor[]> = {
    'Consultant Orthopaedic Surgeon': [
      { name: 'Dr. Deepak Dutta', email: 'bageshwarihospital11@gmail.com', timeSlots: ['4:45 PM', '5:00 PM','5:15 PM', '5:30 PM','5:45 PM', '6:00 PM', '6:15 PM','6:30 PM', '6:45 PM ',  '7.00 PM'] }
    ],
    'Senior Consultant Surgeon': [
      { name: 'Dr. Parshuram Mishra', email: 'bageshwarihospital11@gmail.com', timeSlots: ['11:00 AM','11:30 AM', '12:00 PM', '01:30 PM'] }
    ],
    'Gynecology & Obstetrics': [
      { name: 'Dr. Umakanta Bhattarai', email: 'bageshwarihospital11@gmail.com', timeSlots: [ '4:15 PM','4:30 PM','4:45 PM','5:00 PM', '05:15 PM','5:30 PM', '6:00 PM'] }
    ],
    'General Surgery & Urologist': [
      { name: 'Dr. Rishi Kant Aryal', email: 'bageshwarihospital11@gmail.com', timeSlots: ['5:00 PM','5:30 PM' ] }
    ],
    
    'Internal Medicine': [
      { name: 'Dr. Aburva Shrestha', email: 'bageshwarihospital11@gmail.com', timeSlots: ['09:00 AM', '3:00 PM'] }
    ],
    'ENT Surgeon, Specialization in Pediatric ENT Surgery': [
      { name: 'Dr. Heempali Das Dutta', email: 'bageshwarihospital11@gmail.com', timeSlots: ['4:00 PM - SAT' ] }
    ],
    'ENT Surgeon': [
      { name: 'Dr. Suraj Chandra Sharma', email: 'bageshwarihospital11@gmail.com', timeSlots: ['10:00 AM', '11:00 AM' ] }
    ],
    'Physician & Gastroenterologist': [
      { name: 'Dr. Ram Krishna Baral', email: 'bageshwarihospital11@gmail.com', timeSlots: [ '04:00 PM' ] }
    ],
    'Rardiologist': [
  ...
  const handleInputChange = (field: keyof FormData, value: string) => {
    ...
    if (field === 'department' || field === 'doctor') {
      setFormData(prev => ({ ...prev, doctor: field === 'department' ? '' : prev.doctor, time: '' }));
    }
  };

  const availableDoctors: Doctor[] = formData.department ? doctorsByDepartment[formData.department] || [] : [];
  const selectedDoctor = formData.doctor ? availableDoctors.find(doc => `${doc.name} - ${doc.email}` === formData.doctor) : null;
  const availableTimeSlots = selectedDoctor ? selectedDoctor.timeSlots : [];
            ...
            <Card className="bg-red-50 border-red-200">
              <CardContent className="p-8 text-center">
                ...
                <Button className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-full font-semibold">
                  Call Emergency: ++01-4314194, +01-4315930
                </Button>
              </CardContent>
            </Card>
          </div>
