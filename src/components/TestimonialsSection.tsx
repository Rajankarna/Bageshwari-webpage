...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      review:
        "My son received excellent orthopaedics care from Prof. Dr. Deepak Dutta. The doctor was patient, caring, and explained everything clearly. The child-friendly environment made the visit stress-free.",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "The surgical team at Bageshwari Hospital is world-class. Prof. Dr. Heempali Das performed my surgery with precision and care. The recovery was smooth thanks to the excellent post-operative care.",
      treatment: "ENT Consultation",
      date: "December 2023",
    },
    {
      id: 6,
      name: "Vikram Shrestha",
      image:
        "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80",
      rating: 4,
      review:
        "Outstanding diagnostic services with quick and accurate results. Dr. Apurva Shrestha and his team are highly professional. The pathology reports were detailed and helped in proper treatment planning.",
